...
<h2>자유 게시판</h2>
<div class="buttons">
<input type="button"  value="전체" id="button1"        onclick="location.href='/Board2/Trlist?menu_id=MENU05'">	
<input type="button"  value="유머" id="button2" onclick="location.href='/Board2/Trlist?menu_id=MENU05&subcate=HUMOR'">	
<input type="button"  value="여행 외 정보" id="button3"        onclick="location.href='/Board2/Trlist?menu_id=MENU05&subcate=INFORM'">	
<input type="button"  value="동행구하기" id="button4"  onclick="location.href='/Board2/Trlist?menu_id=MENU05&subcate=WITH'">	
<input type="button"  value="기타" id="button5"        onclick="location.href='/Board2/Trlist?menu_id=MENU05&subcate=ETC3'">	
