...
<script>
	...
	window.onload = function() {
		...
		} else	if( subcate == 'BUSAN' ){
			$("#button3").css("background-color", "#C8EBFA");
		} else	if( subcate == 'JEJU' ){
...
<style>
 h2 { font-size:40px; color:#F47378;]}	
...
table, th, td {  
   ...
   #button1 { padding:0; width:100px; font-size:20px;}
   #button2 { padding:0; width:100px; font-size:20px;}
   #button3 { padding:0; width:100px; font-size:20px;}
   #button4 { padding:0; width:100px; font-size:20px;}
   #button5 { padding:0; width:100px; font-size:20px;}
...
<h2>여행 추천</h2>
<div class="buttons">
<input type="button"  value="전체" id="button1" onclick="location.href='/Board2/Trlist?menu_id=MENU03'">	
<input type="button"  value="서울" id="button2" onclick="location.href='/Board2/Trlist?menu_id=MENU03&subcate=SEOUL'">	
<input type="button"  value="부산" id="button3" onclick="location.href='/Board2/Trlist?menu_id=MENU03&subcate=BUSAN'">	
<input type="button"  value="제주" id="button4" onclick="location.href='/Board2/Trlist?menu_id=MENU03&subcate=JEJU'">	
<input type="button"  value="기타" id="button5" onclick="location.href='/Board2/Trlist?menu_id=MENU03&subcate=ETC'">	
