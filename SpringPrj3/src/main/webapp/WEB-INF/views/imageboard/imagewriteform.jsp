...
<script>
  ...
  $(function () {
    ...
    $('#btnAddFile').on('click',function () {
        let html='';
        html+='<div id="filetemplatediv">';
        html+='    <input type="file" name="upfile'+num+'" class="upfile" style="padding-top: 10px;">';
        html+='    <img src="/img/minus.png" style="width:20px; height:20px" alt="">';
        html+='</div>';
        $('#tdfile').append(html);
        num++;
    })
    $(document).on('click','img',function (e) {
        if($(e.target).parent().attr('id')=='filetemplatediv'){
	...
	<hr>
        <div id="contents" style="display: grid; grid-template-columns: 15% 65%; margin: 0 auto; width: 80%; ">
            ...
            <div id="submenu" style="padding-top: 30px; background-color: #F6C6BD; margin-right:15px; border-radius: 15px; height: 500px;">
                <a href="http://localhost:9090/Board/Community?menu_id=MENU13">여행 추천</a>
                <br>
                <br>
                <a href="http://localhost:9090/Board/List2">여행 Tip</a>
                <br>
                <br>
                <a href="http://localhost:9090/Board/List2">자유 게시판</a>
                <br>
                <br>
                <a href="http://localhost:9090/Board/Community/View?menu_id=MENU13%22">여행 사진</a>
            </div>
            <div id="main" style="margin-left: 20px; display: inline-block; box-sizing: content-box;">

                <form action="http://localhost:9090/Board/Community/ImageWrite" id="form1" method="POST" enctype="multipart/form-data">
                  ...
                  <input type="hidden" name="email" value="gildong@gmail.com">   
                  <div id="writetable">
                    <table id="board" style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td style="padding-left: 7px;" colspan="3">홍길동</td>
                       </tr>
                        <tr>
						...
						<tr>
                            ...
                            <td id="tdfile" style="padding-left: 7px;" colspan="3">
                                <input type="button" id="btnAddFile" value="파일 추가" style="margin-right: 10px;">
